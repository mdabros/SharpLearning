...
namespace SharpLearning.GradientBoost.Test.GBM
{
    ...
    public class ClassificationBinomialGradientBoostLearnerTest
    {
        ...
        public void ClassificationBinomialGradientBoostLearner_Learn()
        {
            ...
            var sut = new ClassificationBinomialGradientBoostLearner(50, 0.1, 3, 1, 1e-6, 1.0, 1);
        ...
        public void ClassificationBinomialGradientBoostLearner_Learn_Indexed()
        {
            ...
            var sut = new ClassificationBinomialGradientBoostLearner(30, 0.1, 3, 1, 1e-6, 1.0, 1);
        ...
        public void ClassificationBinomialGradientBoostLearner_Stochastic_Learn()
        {
            ...
            var sut = new ClassificationBinomialGradientBoostLearner(50, 0.1, 3, 1, 1e-6, .3, 1);
            var model = sut.Learn(observations, targets);
        ...
        public void ClassificationBinomialGradientBoostLearner_Stochastic_Learn_Indexed()
        {
            ...
            var sut = new ClassificationBinomialGradientBoostLearner(30, 0.1, 3, 1, 1e-6, .5, 1);
        ...
        public void ClassificationBinomialGradientBoostLearner_MultiClass_Stochastic_Learn()
        {
            ...
            var sut = new ClassificationBinomialGradientBoostLearner(30, 0.1, 3, 1, 1e-6, 0.5, 1);
            var model = sut.Learn(observations, targets);
