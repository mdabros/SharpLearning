    ...
    public sealed class ClassificationRandomModelSelectingEnsembleLearner : ClassificationModelSelectingEnsembleLearner
    {
        ...
        public ClassificationRandomModelSelectingEnsembleLearner(IIndexedLearner<ProbabilityPrediction>[] learners, int numberOfModelsToSelect, int iterations = 50)
            : this(learners, new StratifiedCrossValidation<ProbabilityPrediction>(5, 42), new MeanProbabilityClassificationEnsembleStrategy(), new LogLossClassificationProbabilityMetric(),
                  numberOfModelsToSelect, iterations)
        {
        }
        ...
        public ClassificationRandomModelSelectingEnsembleLearner(IIndexedLearner<ProbabilityPrediction>[] learners, ICrossValidation<ProbabilityPrediction> crossValidation,
            IClassificationEnsembleStrategy ensembleStrategy, IMetric<double, ProbabilityPrediction> metric, int numberOfModelsToSelect, int iterations = 50, bool selectWithReplacement = true, int seed = 42)
