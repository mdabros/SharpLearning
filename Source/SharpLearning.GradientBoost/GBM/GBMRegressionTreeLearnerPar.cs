...
namespace SharpLearning.GradientBoost.GBM
{
    public sealed class GBMRegressionTreeLearnerPar
    {
        ...
        public GBMRegressionTreeLearnerPar(int maximumTreeDepth, int minimumSplitSize, double minimumInformationGain, int numberOfThreads)
        {
        ...
        public GBMRegressionTreeLearnerPar(int maximumTreeDepth = 2000, int minimumSplitSize = 1, double minimumInformationGain = 1E-6)
            : this(maximumTreeDepth, minimumSplitSize, minimumInformationGain, Environment.ProcessorCount)
        {
        }
