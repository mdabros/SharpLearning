...
{
    /// <summary>
    /// Huber (M) regression gradient boost learner based on 
    ...
    /// </summary>
    public sealed class RegressionHuberGradientBoostLearner : RegressionGradientBoostLearner
    {
        /// <summary>
        ///  Huber (M) regression gradient boost learner. 
        ///  A series of regression trees are fitted stage wise on the residuals of the previous stage
        /// </summary>
        ...
        public RegressionHuberGradientBoostLearner(int iterations = 100, double learningRate = 0.1, int maximumTreeDepth = 3, 
            int maximumLeafCount=2000, int minimumSplitSize = 1, double minimumInformationGain = 0.000001)
            : base(new HuberLossFunction(learningRate), iterations, maximumTreeDepth,maximumLeafCount, 
