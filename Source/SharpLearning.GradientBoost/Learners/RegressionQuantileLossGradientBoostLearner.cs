...
namespace SharpLearning.GradientBoost.Learners
{
    ...
    public class RegressionQuantileLossGradientBoostLearner : RegressionGradientBoostLearner
    {
        ...
        public RegressionQuantileLossGradientBoostLearner(int iterations, double learningRate, int maximumTreeDepth,
            int minimumSplitSize, double minimumInformationGain, double subSampleRatio, int featuresPrSplit, double quantile, int numberOfThreads)
            : base(iterations, learningRate, maximumTreeDepth, minimumSplitSize, minimumInformationGain,
                subSampleRatio, featuresPrSplit, new GradientBoostQuantileLoss(quantile), numberOfThreads)
        ...
        public RegressionQuantileLossGradientBoostLearner(int iterations = 100, double learningRate = 0.1, int maximumTreeDepth = 3,
            int minimumSplitSize = 1, double minimumInformationGain = 0.000001, double subSampleRatio = 1.0, int featuresPrSplit = 0, double quantile = 0.9)
            : base(iterations, learningRate, maximumTreeDepth, minimumSplitSize, minimumInformationGain,
                subSampleRatio, featuresPrSplit, new GradientBoostQuantileLoss(quantile), Environment.ProcessorCount)
        {
        }
    }
}
