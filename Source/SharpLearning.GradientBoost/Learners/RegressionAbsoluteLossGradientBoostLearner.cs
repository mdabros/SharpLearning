...
namespace SharpLearning.GradientBoost.Learners
{
    ...
    public class RegressionAbsoluteLossGradientBoostLearner : RegressionGradientBoostLearner
    {
        ...
        public RegressionAbsoluteLossGradientBoostLearner(int iterations, double learningRate, int maximumTreeDepth,
            int minimumSplitSize, double minimumInformationGain, double subSampleRatio, int featuresPrSplit, int numberOfThreads)
            : base(iterations, learningRate, maximumTreeDepth, minimumSplitSize, minimumInformationGain,
                subSampleRatio, featuresPrSplit, new GradientBoostAbsoluteLoss(), numberOfThreads)
        ...
        public RegressionAbsoluteLossGradientBoostLearner(int iterations = 100, double learningRate = 0.1, int maximumTreeDepth = 3,
            ...
            : base(iterations, learningRate, maximumTreeDepth, minimumSplitSize, minimumInformationGain,
                subSampleRatio, featuresPrSplit, new GradientBoostAbsoluteLoss(), Environment.ProcessorCount)
        {
        }
    }
}
