...
namespace SharpLearning.RandomForest.Test.Learners
{
    ...
    public class ClassificationExtremelyRandomizedTreesLearnerTest
    {
        ...
        [Ignore]
        [TestMethod]
        public void ClassificationExtremelyRandomizedTreesLearner_Learn_Timing()
        {
            var rows = 4000;
            var cols = 10;
            ...
            var sut = new ClassificationExtremelyRandomizedTreesLearner(20, 5, 100, (int)Math.Sqrt(cols), 0.0001, 42);
