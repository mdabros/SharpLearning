...
namespace SharpLearning.Threading.Test
{
    ...
    public class ThreadedWorkerTest
    {
        ...
        public void ThreadedWorker_Arguments()
        {
            new ThreadedWorker<int>(0);
        }

        [TestMethod]
        public void ThreadedWorker_Run_Processor_Count_1()
        {
            var threads = 1;
            var actual = ThreadedWorker_Run(threads);
            Write(actual);
        ...
        [TestMethod]
        public void ThreadedWorker_Run_Processor_Count_Environment_ProcessorCount()
        {
        ...
        int[] ThreadedWorker_Run(int threads)
        {
            var sut = new ThreadedWorker<int>(threads);
            var tasks = new ConcurrentQueue<Action<ConcurrentBag<int>>>();
