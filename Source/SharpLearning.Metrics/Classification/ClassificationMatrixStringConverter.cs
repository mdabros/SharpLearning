...
{
    public sealed class ClassificationMatrixStringConverter
    {
        /// <summary>
        ...
        /// <returns></returns>
        public string Convert(List<double> uniqueTargets, int[][] confusionMatrix, double[][] errorMatrix, double error)
        {
