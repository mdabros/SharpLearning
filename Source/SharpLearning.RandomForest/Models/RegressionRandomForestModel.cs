...
{
    /// <summary>
    /// Regression random forest model consiting of a series of decision trees
    /// </summary>
    public sealed class RegressionRandomForestModel
    {
        ...
        public RegressionRandomForestModel(RegressionDecisionTreeModel[] models, double[] rawVariableImportance)
        {
